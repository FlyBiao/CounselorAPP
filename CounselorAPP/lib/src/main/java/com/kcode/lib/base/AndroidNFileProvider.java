 ...
 * Author FGB
 * Description
 * Created at 2018/4/18 12:00
 * Version 1.0
 */

public class AndroidNFileProvider extends ContentProvider {
    ...
    // @GuardedBy("sCache")
    private static HashMap<String, AndroidNFileProvider.PathStrategy> sCache = new HashMap<String, AndroidNFileProvider.PathStrategy>();

    private AndroidNFileProvider.PathStrategy mStrategy;
    ...
    public static Uri getUriForFile(Context context, String authority, File file) {
        final AndroidNFileProvider.PathStrategy strategy = getPathStrategy(context, authority);
     ...
     */
    private static AndroidNFileProvider.PathStrategy getPathStrategy(Context context, String authority) {
        AndroidNFileProvider.PathStrategy strat;
        synchronized (sCache) {
    ...
    /**
     * Parse and return {@link FileProvider.PathStrategy} for given authority as defined in
     * {@link #META_DATA_FILE_PROVIDER_PATHS} {@code <meta-data>}.
     *
     * @see #getPathStrategy(Context, String)
     */
    private static AndroidNFileProvider.PathStrategy parsePathStrategy(Context context, String authority)
            throws IOException, XmlPullParserException {
        final AndroidNFileProvider.SimplePathStrategy strat = new AndroidNFileProvider.SimplePathStrategy(authority);
     ...
     */
    static class SimplePathStrategy implements AndroidNFileProvider.PathStrategy {
