...
public class RVPIndicator extends LinearLayout {
     ...
     * tab上的内容
     */
    private List<GetCategoryBean> mTabTitles = new ArrayList<GetCategoryBean>();
    ...
    public RVPIndicator(Context context, AttributeSet attrs) {
        ...
        mTextSize = a.getDimensionPixelSize(R.styleable.RVPIndicator_text_size, 12);
     ...
     * @param titleList
     */
    public void setTitleList(List<GetCategoryBean> titleList) {
        mTabTitles.clear();
     ...
     * @param pos
     */
    public void setTitle(GetCategoryBean title, int pos) {
    ...
    public void setViewPager(ViewPager viewPager, int pos) {
            ...
            public void onPageSelected(int position) {
                ...
                if (mOnIndicatorSelected != null) {
                    mOnIndicatorSelected.setOnIndicatorSelected(position,
                            mTabTitles == null ? "" : mTabTitles.get(position).Content);
                }
        ...
        if (mOnIndicatorSelected != null) {
            mOnIndicatorSelected.setOnIndicatorSelected(pos,
                    mTabTitles == null ? "" : mTabTitles.get(pos).Content);
        }
    ...
    private void setTabItem() {
        if (mTabTitles != null && mTabTitles.size() > 0) {
            ...
            for (GetCategoryBean title : mTabTitles) {
                measure(0, 0);
                addView(createTextView(title.Content));
            }
