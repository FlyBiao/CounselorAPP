...
public class RequierGoodsDetailScanAdapter extends SwipeMenuAdapter<RequierGoodsDetailScanAdapter.DefaultViewHolder> {

    private List<MoveDeliveryGoodsDetailBean> mData=new ArrayList<>();
    private OnItemClickListener mOnItemClickListener;
    static Context mContext;

    public RequierGoodsDetailScanAdapter(List<MoveDeliveryGoodsDetailBean>  data, Context mContext){
        this.mData=data;
