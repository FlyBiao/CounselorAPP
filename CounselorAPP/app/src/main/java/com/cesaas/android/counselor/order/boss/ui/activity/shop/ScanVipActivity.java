 ...
 * 扫描会员
 */
public class ScanVipActivity extends BasesActivity implements View.OnClickListener{
    ...
    public void initData(){
        ...
        WebViewUtils.initWebSettings(wvOnLineShop,mDialog, Urls.RESULTS_MSCAN_VIP+Id);
