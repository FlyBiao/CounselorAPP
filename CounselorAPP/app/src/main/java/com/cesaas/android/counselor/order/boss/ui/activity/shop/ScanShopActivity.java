 ...
 * 扫描商品
 */
public class ScanShopActivity extends BasesActivity implements View.OnClickListener{
    ...
    public void initData(){
        ...
        WebViewUtils.initWebSettings(wvOnLineShop,mDialog, Urls.RESULTS_MSCAN_SHOP+Id);
