...
/**
 * Author FGB
 * Description 待处理会员服务-生日祝福
 * Created at 2018/2/27 17:33
 * Version 1.0
 */

public class DealMemberServiceBirthFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private MemberDealServiceBirthAdapter adapter;
     ...
     * 单例
     */
    public static DealMemberServiceBirthFragment newInstance() {
        DealMemberServiceBirthFragment fragmentCommon = new DealMemberServiceBirthFragment();
...
//        });
    ...
    public void onEventMainThread(ResultBirthdayWishesServiceListBean msg) {
        if(msg.IsSuccess!=false){
            ...
            if(msg.TModel!=null && msg.TModel.size()!=0){
                ...
                adapter=new MemberDealServiceBirthAdapter(mData,getActivity(),getContext());
