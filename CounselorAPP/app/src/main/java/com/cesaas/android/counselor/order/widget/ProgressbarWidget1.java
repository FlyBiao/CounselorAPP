 ...
 *
 */
public class ProgressbarWidget1 extends View {
	...
	public ProgressbarWidget1(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}

	public ProgressbarWidget1(Context context, AttributeSet attribute) {
	...
	protected void onDraw(Canvas canvas) {
		...
		super.onDraw(canvas);
		// 绘制底色
		paint.setColor(getResources().getColor(R.color.azure));
