...
public class CustomSalesCenterProgress extends View {
...
//    private int[] colors = new int[]{Color.GREEN, Color.YELLOW, Color.RED, Color.RED};
    ...
    public CustomSalesCenterProgress(Context context) {
        super(context);
    }

    public CustomSalesCenterProgress(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//        canvas.drawText("胖", getWidth()-marging, centerX+marging+textSize+padding, vTextPaint);
        ...
        canvas.drawText("销售中心", getWidth()/2, (int)((centerX+marging)/3*1.5+textSize), vTextPaint);
