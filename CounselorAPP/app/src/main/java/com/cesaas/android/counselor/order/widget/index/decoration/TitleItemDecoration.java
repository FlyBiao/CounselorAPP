package com.cesaas.android.counselor.order.widget.index.decoration;
...
import com.cesaas.android.counselor.order.widget.indexbar.BaseIndexTagBean;
...
public class TitleItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (mDatas == null ||mDatas.isEmpty() || position > mDatas.size() - 1) {//pos为1，size为1，1>zero? true
                return;//越界
            }
...
/*
    ...
    public void onDrawOver(Canvas c, final RecyclerView parent, RecyclerView.State state) {//最后调用 绘制在最上层
        ...
        if (mDatas == null ||mDatas.isEmpty() || pos > mDatas.size() - 1) {//pos为1，size为1，1>zero? true
            return;//越界
        }
...
/*        Button button = new Button(parent.getContext());
        ...
        button.setText("无哈");
        *//*button.measure(View.MeasureSpec.makeMeasureSpec(zero,View.MeasureSpec.EXACTLY),View.MeasureSpec.makeMeasureSpec(zero,View.MeasureSpec.EXACTLY));
*//*
