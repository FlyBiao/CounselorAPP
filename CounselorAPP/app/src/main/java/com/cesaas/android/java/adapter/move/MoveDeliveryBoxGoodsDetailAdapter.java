...
public class MoveDeliveryBoxGoodsDetailAdapter extends BaseQuickAdapter<MoveDeliveryGoodsDetailBean, BaseViewHolder> {
    ...
    public MoveDeliveryBoxGoodsDetailAdapter(List<MoveDeliveryGoodsDetailBean> mData, Activity activity, Context ct) {
        super(R.layout.item_imove_delivery_box_goods_detail,mData);
        this.mData=mData;
