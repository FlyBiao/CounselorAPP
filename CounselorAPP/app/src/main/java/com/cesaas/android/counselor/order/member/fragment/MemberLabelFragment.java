...
import static com.cesaas.android.counselor.order.R.id.rv_shopping_record_list;
...
public class MemberLabelFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if(MemberReturnVisitDetailsActivity.getVipId()!=0){
            net.setData(MemberReturnVisitDetailsActivity.getVipId()+"");
        }else{
