...
public class DateScreeningActivity extends BasesActivity implements View.OnClickListener ,DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_member_service_screening);
        initView();
        initData();
    }
...
//                ToastFactory.getLongToast(mContext,TimeDataUtils.getCurrentDates().get(positoin).getDateTitle());
    ...
    public void getDateSelect(View v){
        ...
        DatePickerDialog dpd = DatePickerDialog.newInstance(DateScreeningActivity.this,now.get(Calendar.YEAR), now.get(Calendar.MONTH), now.get(Calendar.DAY_OF_MONTH));
