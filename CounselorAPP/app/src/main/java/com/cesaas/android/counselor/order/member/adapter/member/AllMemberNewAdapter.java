...
public class AllMemberNewAdapter extends BaseQuickAdapter<MemberServiceListBean, BaseViewHolder> {
    ...
    public AllMemberNewAdapter(List<MemberServiceListBean> mData, Activity activity, Context context) {
