 ...
 * 进店报表
 */
public class IntoReportActivity extends BasesActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_into_report);
    ...
    public void initView(){
        wv_member= (WebView) findViewById(R.id.wv_into_shop);
    ...
    public void initData(){
        ...
        WebViewUtils.initWebSettings(wv_member,mDialog, Urls.INTO_SHOP_REPORT);
