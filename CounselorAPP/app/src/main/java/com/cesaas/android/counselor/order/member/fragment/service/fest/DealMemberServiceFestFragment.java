...
import com.cesaas.android.counselor.order.member.adapter.service.fest.MemberDealServiceFestAdapter;
...
/**
 * Author FGB
 * Description 待处理会员服务-节日安排
 * Created at 2018/2/27 17:33
 * Version 1.0
 */

public class DealMemberServiceFestFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private MemberDealServiceFestAdapter adapter;
     ...
     * 单例
     */
    public static DealMemberServiceFestFragment newInstance() {
        DealMemberServiceFestFragment fragmentCommon = new DealMemberServiceFestFragment();
    ...
    public void initData() {
        net=new FestivalListNet(getContext(),1);
...
//        });
    ...
    public void onEventMainThread(ResultHolidayServiceListBean msg) {
        if(msg.IsSuccess!=false){
            ...
            if(msg.TModel!=null && msg.TModel.size()!=0){
                ...
                adapter=new MemberDealServiceFestAdapter(mData,getActivity(),getContext());
