...
public class MoreReturnServiceFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
     ...
     * 单例
     */
    public static MoreReturnServiceFragment newInstance() {
        MoreReturnServiceFragment fragmentCommon = new MoreReturnServiceFragment();
