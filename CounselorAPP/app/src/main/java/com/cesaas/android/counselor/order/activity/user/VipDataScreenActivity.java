...
/**
 * Author FGB
 * Description 会员数据统计筛选页面
 * Created 2017/3/2 16:33
 * Version 1.zero
 */

public class VipDataScreenActivity extends BasesActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vip_data_screen);
    ...
    public void getDateSelect(View v){
        ...
        DatePickerDialog dpd = DatePickerDialog.newInstance(VipDataScreenActivity.this,now.get(Calendar.YEAR), now.get(Calendar.MONTH), now.get(Calendar.DAY_OF_MONTH));
