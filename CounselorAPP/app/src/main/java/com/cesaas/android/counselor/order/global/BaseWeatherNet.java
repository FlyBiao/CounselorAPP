...
public class BaseWeatherNet {
	...
	public BaseWeatherNet(Context context, boolean show) {
...
//					Log.i(TAG, "auth=="+auth.toString());
			...
			Log.i(Constant.TAG,"发送请求:" +"URL="+ Constant.WEATHER + uri + "--数据参数=:" + data);
			
			HttpUtils http = new HttpUtils();
			http.send(HttpMethod.GET, Constant.WEATHER + uri, params, new RequestCallBack<HttpUtils>() {
				@Override
