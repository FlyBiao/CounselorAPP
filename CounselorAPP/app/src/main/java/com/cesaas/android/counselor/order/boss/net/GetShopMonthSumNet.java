...
public class GetShopMonthSumNet extends BaseNet {

    public GetShopMonthSumNet(Context context) {
        super(context, true);
        this.uri="Marketing/Sw/SaleGoal/GetShopMonthSum";
    }
    ...
    protected void mSuccess(String rJson) {
        ...
        ResultGetShopMonthSumBean bean= JsonUtils.fromJson(rJson,ResultGetShopMonthSumBean.class);
