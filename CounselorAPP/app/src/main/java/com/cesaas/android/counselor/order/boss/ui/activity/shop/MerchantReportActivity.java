 ...
 * 商品报表
 */
public class MerchantReportActivity extends BasesActivity implements View.OnClickListener{
    ...
    private void initView() {
        ...
        wv_merchant_report= (WebView) findViewById(R.id.wv_merchant_report);
    ...
    public void initData(){
        ...
        BaseInitJavascriptInterface.initJavascriptInterface(mContext,mActivity,mMaterialDialog,wv_merchant_report,bundle,prefs,tvTitle,mTextViewRightTitle,0,101);
    }

    @Override
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        super.onActivityResult(requestCode, resultCode, data);
        BaseActivityResult result=new BaseActivityResult(mContext,mActivity,wv_merchant_report);
