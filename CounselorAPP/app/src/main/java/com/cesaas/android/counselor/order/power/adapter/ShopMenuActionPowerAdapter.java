...
public class ShopMenuActionPowerAdapter extends BaseQuickAdapter<MenuDataBean, BaseViewHolder> {

    private List<MenuDataBean> mData;

    public ShopMenuActionPowerAdapter(List<MenuDataBean> mData) {
        super( R.layout.item_shop_menu,mData);
        this.mData=mData;
    }
