...
import com.cesaas.android.counselor.order.shopmange.adapter.CollectionShopAdapter;
...
public class CollectionShopFragment extends Fragment {
    ...
    private CollectionShopNet mCollectionShopNet;
    private CollectionShopAdapter mAllShopAdapter;
    ...
    public static CollectionShopFragment newInstance() {
        CollectionShopFragment fragmentCommon = new CollectionShopFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.fragment_collectionshop_layout, container, false);
        initView();
        return view;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mCollectionShopNet=new CollectionShopNet(getContext());
        mCollectionShopNet.setData(pageIndex,Type);
        initData();
    }
    ...
    private void initView() {
        ...
        mSwipeMenuRecyclerView= (SwipeMenuRecyclerView) view.findViewById(R.id.recycler_collection_shop_view);
    ...
    public class CollectionShopNet extends BaseNet {
        ...
        protected void mSuccess(String rJson) {
            ...
            if(bean.IsSuccess==true){
                ...
                mAllShopAdapter=new CollectionShopAdapter(mAllShopBeanList,getContext());
