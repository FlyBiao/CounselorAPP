...
public class NewHomeTestFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    TextView tv_score,tv_score1,tv_score2,tv_score3,tv_score4,tv_score5;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private LinearLayout ll_sales_data,ll_task_data,ll_visit_data,ll_order_data,ll_face_list;
     ...
     * 单例
     */
    public static NewHomeTestFragment newInstance() {
        NewHomeTestFragment fragmentCommon = new NewHomeTestFragment();
        return fragmentCommon;
    }

    @Override
    public int getLayoutId() {
        return R.layout.fragment_new_home_test;
    }
