 ...
 * 试穿报表
 */
public class TryReportActivity extends BasesActivity {
    ...
    public void initView(){
        ...
        wv_member= (WebView) findViewById(R.id.wv_try);
    ...
    public void initData(){
        ...
        WebViewUtils.initWebSettings(wv_member,mDialog, Urls.TRY_REPORT);
