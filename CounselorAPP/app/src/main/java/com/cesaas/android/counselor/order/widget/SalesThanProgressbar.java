 ...
 *
 */
public class SalesThanProgressbar extends View {
	...
	private float offsetRight = 10f; // 灰色线条距离右边的距离
	private int textSize = 50; // 百分比的文字大小
	private float offsetTop = 30f; // 距离顶部的偏移量

	public SalesThanProgressbar(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}

	public SalesThanProgressbar(Context context, AttributeSet attribute) {
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawLine(10, offsetTop, getWidth(), offsetTop, paint);
		// 绘制进度条颜色
...
//		paintText.setColor(getResources().getColor(R.color.gray_1));
