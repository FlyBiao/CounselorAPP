...
public class BaseJavaNet {
	...
	public BaseJavaNet(Context context, boolean show) {
	...
	public void mPostNet() {
		if (App.mInstance().getNetType() != NetworkUtil.NO_NETWORK) {
			...
			Log.i(Constant.JAVA_TAG,"参数:"+ Constant.JAVA_TEST_IP+ uri + "\n" + data+ "\n");
	...
	protected void mSuccess(String rJson) {
		Log.i(Constant.JAVA_TAG,"result:"+ rJson);
        ToastFactory.getLongToast(mContext,rJson+"===result");
	}

	protected void mFail(HttpException e, String err) {
		LogUtils.d(Constant.JAVA_TAG+ err+"=e"+err);
		Log.i(Constant.JAVA_TAG,"\n\n" +e+"err："+err);
