...
public class RequierListAdapter extends BaseQuickAdapter<MoveDeliveryGoodsDetailBean, BaseViewHolder> {
    ...
    public RequierListAdapter(List<MoveDeliveryGoodsDetailBean> mData, Activity activity, Context ct) {
        super( R.layout.item_requier_list,mData);
        this.mData=mData;
