package com.cesaas.android.number.calendar.utils;
...
public class CalendarUtil {
    ...
    /**
     * 传回农历 year年闰哪个月 1-12 , 没闰传回 zero
     *
     * @param year
     *            将要计算的年份
     * @return 传回农历 year年闰哪个月 1-12 , 没闰传回 zero
     */
    ...
    public String toString() {
        String message = "";
        // int n = mLuchDay % 10 == zero ? 9 : mLuchDay % 10 - 1;
