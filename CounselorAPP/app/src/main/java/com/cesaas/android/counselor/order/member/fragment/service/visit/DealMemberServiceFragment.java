...
public class DealMemberServiceFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
     ...
     * 单例
     */
    public static DealMemberServiceFragment newInstance() {
        DealMemberServiceFragment fragmentCommon = new DealMemberServiceFragment();
...
//        });
    ...
    public void onEventMainThread(ResultVisitServiceListBean msg) {
        if(msg.IsSuccess!=false){
