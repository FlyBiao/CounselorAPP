...
/**
 * Author FGB
 * Description 手机和生日修改申请列表-待处理
 * Created at 2018/2/27 10:56
 * Version 1.0
 */

public class MemberDealInfoAdapter extends BaseQuickAdapter<MemberApplyListBean, BaseViewHolder> {

    private Activity mActivity;
    private List<MemberApplyListBean> mData;

    public MemberDealInfoAdapter(List<MemberApplyListBean> mData,Activity activity) {
        super( R.layout.item_member_deal_info,mData);
        this.mData=mData;
...
//            }
//        });
        helper.setOnClickListener(R.id.ll_appay, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BottonDialogUtils.showMemberApplyBottonDialog(mContext,mActivity,item);
            }
        });
    }
}
