...
public class DepartmentContactFragment extends Fragment{
    ...
    private int type=3;	//查询类型： 0=全部，1=最近联系人，2=组联系人，3=部门联系人
    ...
    public static DepartmentContactFragment newInstance() {
        DepartmentContactFragment fragmentCommon = new DepartmentContactFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.fragment_department_contact_layout, container, false);
        initView();
        return view;
    }
    ...
    private void initView() {
        ...
        mSwipeMenuRecyclerView = (SwipeMenuRecyclerView) view.findViewById(R.id.recycler_department_contact_view);
