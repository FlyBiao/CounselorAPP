...
public class ReceiveGoodsDetailScanAdapter extends SwipeMenuAdapter<ReceiveGoodsDetailScanAdapter.DefaultViewHolder> {

    private List<MoveDeliveryGoodsDetailBean> mData=new ArrayList<>();
    private OnItemClickListener mOnItemClickListener;
    static Context mContext;

    public ReceiveGoodsDetailScanAdapter(List<MoveDeliveryGoodsDetailBean>  data, Context mContext){
        this.mData=data;
