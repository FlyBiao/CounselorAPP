package com.cesaas.android.counselor.order.member.adapter.service;
 ...
 */
public class MemberTagAdapter<T> extends BaseAdapter implements OnInitSelectedPosition {

    private final Context mContext;
    private final List<GetTagListBean> mDataList;

    public MemberTagAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.tag_membet_item, null);
