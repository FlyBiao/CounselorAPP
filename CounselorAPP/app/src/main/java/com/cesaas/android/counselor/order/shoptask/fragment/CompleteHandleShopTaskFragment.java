...
/**
 * Author FGB
 * Description 完成处理店务任务列表Fragment
 * Created at 2017/5/11 10:08
 * Version 1.0
 */

public class CompleteHandleShopTaskFragment extends Fragment{
     ...
     * 单例
     */
    public static CompleteHandleShopTaskFragment newInstance() {
        CompleteHandleShopTaskFragment fragmentCommon = new CompleteHandleShopTaskFragment();
    ...
    private void initData(){
        ...
        mTaskListNet.setData(pageIndex,pageSize,1);
    }
