...
public class TimeOutMemberServiceFestFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public static TimeOutMemberServiceFestFragment newInstance() {
        TimeOutMemberServiceFestFragment fragmentCommon = new TimeOutMemberServiceFestFragment();
    ...
    public void initData() {
        net=new FestivalListNet(getContext(),3);
    ...
    public void onEventMainThread(ResultHolidayServiceTimeOutListBean msg) {
        if(msg.IsSuccess!=false){
            if(msg.TModel!=null && msg.TModel.size()!=0){
                tv_not_data.setVisibility(View.GONE);
                mData=new ArrayList<>();
                mData.addAll(msg.TModel);
                adapter=new TimeOutMemberServiceFestAdapter(mData,getActivity(),getContext());
