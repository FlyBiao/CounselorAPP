...
public class ShopSellNumberActivity extends BasesActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shop_sell_number);
    ...
    private void initView() {
        ...
        wvOnLineShop= (WebView) findViewById(R.id.wv_shop_sell_number);
    ...
    public void initData(){
        ...
        if (shopType!=0){
            WebViewUtils.initWebSettings(wvOnLineShop,mDialog, Urls.RESULTS_PRODUCT+shopType);
        }else{
            WebViewUtils.initWebSettings(wvOnLineShop,mDialog, Urls.RESULTS_PRODUCT_ALL);
        }
            ...
            public void onFailure(PutObjectRequest arg0,
                ...
                if (clientExcepion != null) {
                    ...
                    mActivity.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ToastFactory.getLongToast(mContext,"本地异常如网络异常等");
                        }
                    });
