...
/**
 * Author FGB
 * Description 会员管理 Gridview
 * Created 2017/4/11 19:55
 * Version 1.zero
 */
public class MemberMangerGridviewAdapter extends BaseAdapter {
    ...
    public MemberMangerGridviewAdapter(Context mContext,List<String> menuName,List<Integer> imgs) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(
                    R.layout.grid_item_member, parent, false);
        }
