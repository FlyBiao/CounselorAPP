...
public class CheckDealMemberServiceFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public static CheckDealMemberServiceFragment newInstance() {
        CheckDealMemberServiceFragment fragmentCommon = new CheckDealMemberServiceFragment();
    ...
    public void initData() {
        net=new CheckServiceDetailNet(getContext(),1);
        net.setData(MemberServiceCheckDetailActivity.getId(),10);
    }

    public void onEventMainThread(ResultCheckDealServiceDetailsBean msg) {
        if(msg.IsSuccess!=false){
            if(msg.TModel!=null && msg.TModel.size()!=0){
                ...
                adapter=new MemberCheckDealServiceAdapter(mData);
