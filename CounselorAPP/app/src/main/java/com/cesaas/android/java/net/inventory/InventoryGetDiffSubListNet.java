...
public class InventoryGetDiffSubListNet extends TestBaseNet {

    public InventoryGetDiffSubListNet(Context context) {
        super(context, true);
        this.uri="drp/inventoryGetDiffSubList";
    }
    ...
    protected void mSuccess(String rJson) {
        ...
        ResultInventoryGetDiffSubListBean bean= JsonUtils.fromJson(rJson,ResultInventoryGetDiffSubListBean.class);
