...
import com.cesaas.android.counselor.order.shopmange.net.AttentionShopNet;
...
/**
 * Author FGB
 * Description 所有商品Adapter
 * Created 2017/4/27 17:57
 * Version 1.0
 */
public class AllShopAdapter extends SwipeMenuAdapter<AllShopAdapter.DefaultViewHolder>{
    ...
    public AllShopAdapter(List<AllShopBean> mAllShopBeanList,Context mContext){
