...
public class NotPayCounselorOrderNet extends BaseNet {

    public NotPayCounselorOrderNet(Context context) {
        super(context, true);
    ...
    protected void mSuccess(String rJson) {
        ...
        Gson gson = new Gson();
        ResultNotPayCounselorOrderBean lbean = gson.fromJson(rJson,ResultNotPayCounselorOrderBean.class);
