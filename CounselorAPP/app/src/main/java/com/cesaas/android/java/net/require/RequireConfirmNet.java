...
public class RequireConfirmNet extends TestBaseNet {

    public RequireConfirmNet(Context context) {
        super(context, true);
            this.uri="drp/requireConfirm";
    }
    ...
    protected void mSuccess(String rJson) {
        ...
        ResultRequireConfirmBean bean= JsonUtils.fromJson(rJson,ResultRequireConfirmBean.class);
