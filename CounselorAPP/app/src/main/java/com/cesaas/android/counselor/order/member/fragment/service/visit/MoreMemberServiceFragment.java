...
public class MoreMemberServiceFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
     ...
     * 单例
     */
    public static MoreMemberServiceFragment newInstance() {
        MoreMemberServiceFragment fragmentCommon = new MoreMemberServiceFragment();
