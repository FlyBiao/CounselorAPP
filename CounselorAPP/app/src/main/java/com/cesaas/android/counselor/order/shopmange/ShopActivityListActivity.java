 ...
 * 店铺营销活动列表
 */
public class ShopActivityListActivity extends BasesActivity {
    ...
    public void initView(){
        ...
        wv_member= (WebView) findViewById(R.id.wv_shop_activity);
    ...
    public void initData(){
        ...
        WebViewUtils.initWebSettings(wv_member,mDialog, Urls.SHOP_ACTIVITY);
        InitJavascriptInterface.initJavascriptInterface(wv_member,mContext);
//        BaseInitJavascriptInterface.initJavascriptInterface(mContext,mActivity,mMaterialDialog,wv_member,bundle,prefs,mTextViewTitle,mTextViewRightTitle);
    }
