...
public class MemberServiceBirthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try{
            ...
            TabViewChild tabViewChild1 = new TabViewChild(R.mipmap.deals, R.mipmap.deal, "待处理", DealMemberServiceBirthFragment.newInstance());
            TabViewChild tabViewChild2 = new TabViewChild(R.mipmap.completes, R.mipmap.complete, "已完成", CompleteMemberServiceBirthFragment.newInstance());
