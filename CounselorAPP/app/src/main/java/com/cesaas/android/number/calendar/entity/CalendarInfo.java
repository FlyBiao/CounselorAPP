package com.cesaas.android.number.calendar.entity;
...
public class CalendarInfo {
     ...
     * @param des 事务描述
     */
    public CalendarInfo(int year, int month, int day,String salesCounts, String des) {
        this.year = year;
        this.month = month;
        this.day = day;
        this.des = des;
