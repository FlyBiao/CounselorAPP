...
/**
 * Author FGB
 * Description 已发货货顾问订单
 * Created at 2017/5/28 23:01
 * Version 1.0
 */

public class WaitInCounselorOrderNet extends BaseNet {

    public WaitInCounselorOrderNet(Context context) {
        super(context, true);
    ...
    protected void mSuccess(String rJson) {
        ...
        Log.i(Constant.TAG,"已发货:============================"+rJson);
        Gson gson = new Gson();
        ResultWaitInCounselorOrderBean lbean = gson.fromJson(rJson,ResultWaitInCounselorOrderBean.class);
