...
public class WaitOutCounselorOrderNet extends BaseNet {

    public WaitOutCounselorOrderNet(Context context) {
        super(context, true);
    ...
    protected void mSuccess(String rJson) {
        ...
        Gson gson = new Gson();
        ResultWaitOutCounselorOrderBean lbean = gson.fromJson(rJson,ResultWaitOutCounselorOrderBean.class);
