...
public class FocusMemberFragment extends BaseFragment implements BaseQuickAdapter.RequestLoadMoreListener,SwipeRefreshLayout.OnRefreshListener,FocusMemberAdapter.MyOnItemClickListener{
    ...
    private TextView tv_not_data,tv_focus_member_sum,tv_select_o;
    ...
    public static FocusMemberFragment newInstance() {
        FocusMemberFragment fragmentCommon = new FocusMemberFragment();
    ...
    public void onEventMainThread(SearchVipEventBean msg) {
        if(msg.getType()==40){
            ...
            net.setData(pageIndex,3,msg.getContent());
        }
    }

    public void onEventMainThread(ResultQueryVipBean msg) {
        if(msg!=null && msg.getMemberType()==40){
...
//            bean.setFilters(queryVipBean.getVipInfo());
    ...
    public void onEventMainThread(ResultSetRemarkBean msg) {
        if(MemberType==4){
            if(msg.IsSuccess!=false){
                ...
                net=new MemberServiceListNet(getContext(),4);
                net.setData(pageIndex,3);
            }else{
    ...
    public void onEventMainThread(ResultFocusMemberServiceListBean msg) {
        if(msg.IsSuccess!=false){
            if(msg.TModel!=null && msg.TModel.size()!=0){
                totalSize=msg.RecordCount;
                tv_focus_member_sum.setText(msg.RecordCount+"");
                ...
                if(isLoadMore==true){
                    ...
                    adapter=new FocusMemberAdapter(mData,getActivity(),getContext());
                    adapter.notifyDataSetChanged();
    ...
    public void initViews() {
        ...
        tv_focus_member_sum=findView(R.id.tv_focus_member_sum);
