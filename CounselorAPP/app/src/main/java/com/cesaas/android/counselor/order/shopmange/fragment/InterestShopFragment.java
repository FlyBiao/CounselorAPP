...
import com.cesaas.android.counselor.order.shopmange.adapter.InterestShopAdapter;
...
import com.cesaas.android.counselor.order.shopmange.bean.ResultInterestShopBean;
 ...
 * Version 1.0
 */
public class InterestShopFragment extends Fragment {
    ...
    private GetInterestShopNet mGetInterestShopNet;
    private InterestShopAdapter mAllShopAdapter;
     ...
     * 单例
     */
    public static InterestShopFragment newInstance() {
        InterestShopFragment fragmentCommon = new InterestShopFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.fragment_interest_shop_layout, container, false);
        initView();
        return view;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mGetInterestShopNet=new GetInterestShopNet(getContext());
        mGetInterestShopNet.setData(pageIndex,Type);
        initData();
    }
    ...
    private void initView() {
        ...
        mSwipeMenuRecyclerView= (SwipeMenuRecyclerView) view.findViewById(R.id.recycler_interest_shop_view);
     ...
     * Version 1.0
     */
    public class GetInterestShopNet extends BaseNet {
        public GetInterestShopNet(Context context) {
            super(context, true);
        ...
        protected void mSuccess(String rJson) {
            ...
            ResultInterestShopBean bean= JsonUtils.fromJson(rJson,ResultInterestShopBean.class);
            if(bean.IsSuccess==true){
                mAllShopBeanList=new ArrayList<>();
                mAllShopBeanList.addAll(bean.TModel);

                mAllShopAdapter=new InterestShopAdapter(mAllShopBeanList,getContext());
