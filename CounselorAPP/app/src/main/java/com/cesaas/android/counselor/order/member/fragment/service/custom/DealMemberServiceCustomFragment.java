...
import com.cesaas.android.counselor.order.member.adapter.service.custom.MemberDealServiceCustomAdapter;
...
/**
 * Author FGB
 * Description 待处理会员服务-会员定制
 * Created at 2018/2/27 17:33
 * Version 1.0
 */

public class DealMemberServiceCustomFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private MemberDealServiceCustomAdapter adapter;
     ...
     * 单例
     */
    public static DealMemberServiceCustomFragment newInstance() {
        DealMemberServiceCustomFragment fragmentCommon = new DealMemberServiceCustomFragment();
...
//        });
    ...
    public void onEventMainThread(ResultCustomServiceListBean msg) {
        if(msg.IsSuccess!=false){
            ...
            if(msg.TModel!=null && msg.TModel.size()!=0){
                ...
                adapter=new MemberDealServiceCustomAdapter(mData,getActivity(),getContext());
