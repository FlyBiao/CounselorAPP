...
//    private int[] colors = new int[]{Color.GREEN, Color.YELLOW, Color.RED, Color.RED};
    ...
    public CustomArcCircleProgress(Context context) {
        super(context);
    }

    public CustomArcCircleProgress(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//        canvas.drawText("胖", getWidth()-marging, centerX+marging+textSize+padding, vTextPaint);
        ...
        canvas.drawText("全国", getWidth()/2, (int)((centerX+marging)/3*1.5+textSize), vTextPaint);
