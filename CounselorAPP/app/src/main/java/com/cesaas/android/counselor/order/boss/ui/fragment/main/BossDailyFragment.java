...
public class BossDailyFragment extends BaseFragment {
     ...
     * 单例
     */
    public static BossDailyFragment newInstance() {
        BossDailyFragment fragmentCommon = new BossDailyFragment();
    ...
    public int getLayoutId() {
        return R.layout.fragment_boss_daily;
    }
    ...
    public void initViews() {
        ...
        wvOnLineShop=findView(R.id.wv_on_line_shop);
    ...
    public void initData() {
        ...
        WebViewUtils.initWebSettings(wvOnLineShop,mDialog, Urls.RESULTS_DAILY);
        BaseInitJavascriptInterface.initJavascriptInterface(getContext(),getActivity(),mMaterialDialog,wvOnLineShop,bundle,prefs,tvTitle,mTextViewRightTitle,0,1,0);
    }
            ...
            public void onSuccess(PutObjectRequest request, PutObjectResult result) {
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        //执行分享操作
                        //执行分享操作
                        showShare(tvTitle.getText().toString(),ossImageUrl,ossImageUrl,"日报数据");
                    }
                });
            }
        });
