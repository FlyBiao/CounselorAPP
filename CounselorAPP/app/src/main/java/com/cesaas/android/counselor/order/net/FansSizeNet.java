...
import com.cesaas.android.counselor.order.bean.ResultFansSize;
 ...
 * 
 */
public class FansSizeNet extends BaseNet {
	
	public FansSizeNet(Context context) {
		super(context, true);
	...
	protected void mSuccess(String rJson) {
		...
		Gson gson = new Gson();
		ResultFansSize lbean = gson.fromJson(rJson, ResultFansSize.class);
