...
public class ReceiveRouteOrderAdapter extends BaseQuickAdapter<UnReceiveOrderBean, BaseViewHolder> {
    ...
    public ReceiveRouteOrderAdapter(List<UnReceiveOrderBean> mData, Activity activity, Context context) {
        super( R.layout.item_receive_route_order,mData);
        this.mData=mData;
    ...
    protected void convert(BaseViewHolder helper, final UnReceiveOrderBean item) {
        ...
        helper.setOnClickListener(R.id.tv_express_send, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                RevceiveRouteOrderEventBean bean=new RevceiveRouteOrderEventBean();
