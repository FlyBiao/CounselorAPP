...
public class ShopSeasonTagAdapter<T> extends BaseAdapter implements OnInitSelectedPosition {

    private final Context mContext;
    private final List<ShopSeasonBean> mDataList;

    public ShopSeasonTagAdapter(Context context) {
    ...
    public void onlyAddAll(List<ShopSeasonBean> datas) {
        mDataList.addAll(datas);
        notifyDataSetChanged();
    }

    public void clearAndAddAll(List<ShopSeasonBean> datas) {
        mDataList.clear();
        onlyAddAll(datas);
    }
