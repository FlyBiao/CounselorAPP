...
public class MemberCheckGoShopServiceAdapter extends BaseQuickAdapter<CheckServiceDetailsBean, BaseViewHolder> {

    private List<CheckServiceDetailsBean> mData;

    public MemberCheckGoShopServiceAdapter(List<CheckServiceDetailsBean> mData) {
        super( R.layout.item_member_check_goshop_service,mData);
        this.mData=mData;
    }
