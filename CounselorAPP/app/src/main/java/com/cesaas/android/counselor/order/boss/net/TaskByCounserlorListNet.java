 ...
 * Version 1.0
 */
public class TaskByCounserlorListNet extends BaseNet {

    public TaskByCounserlorListNet(Context context) {
        super(context, true);
        this.uri="MemberTask/Sw/Task/TaskByCounserlorList";
    }

    public void setData(String FromDate, String ToDate, int ShopIds,int ServiceType) {
        try {
            data.put("FromDate",FromDate);
            data.put("ToDate",ToDate);
            data.put("ShopId",ShopIds);
    ...
    protected void mSuccess(String rJson) {
        ...
        ResultTaskByCounserlorListBean bean=JsonUtils.fromJson(rJson,ResultTaskByCounserlorListBean.class);
