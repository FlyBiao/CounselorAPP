 ...
 * 地图定点页面
 */
public class MapFixedPointActivity extends BasesActivity implements LocationSource,
...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.activity_map_fixed_point);
...
////                ToastFactory.getLongToast(mContext,resultData.get(position).getTitle());
//            }
//        });
    }
    ...
    private void initView() {
        ...
        tvBaseTitle.setText("地图定点");
        listView = (ListView) findViewById(R.id.listview);
        searchResultAdapter = new SearchResultAdapter(MapFixedPointActivity.this);
        ...
        searchText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (newText.length() > 0) {
                    ...
                    Inputtips inputTips = new Inputtips(MapFixedPointActivity.this, inputquery);
...
//        Log.i("MY", "doSearchQuery");
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            Toast.makeText(MapFixedPointActivity.this, "error code is " + rCode, Toast.LENGTH_SHORT).show();
        }
    }
            ...
            if (poiResult != null && poiResult.getQuery() != null) {
                if (poiResult.getQuery().equals(query)) {
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        Toast.makeText(MapFixedPointActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
                    }
                }
            } else {
                Toast.makeText(MapFixedPointActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
    ...
    Inputtips.InputtipsListener inputtipsListener = new Inputtips.InputtipsListener() {
        ...
        public void onGetInputtips(List<Tip> list, int rCode) {
            if (rCode == AMapException.CODE_AMAP_SUCCESS) {// 正确返回
                ...
                Toast.makeText(MapFixedPointActivity.this, "erroCode " + rCode , Toast.LENGTH_SHORT).show();
            }
        }
    };
