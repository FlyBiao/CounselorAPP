...
import com.cesaas.android.counselor.order.member.adapter.service.dormancy.TimeOutMemberServiceDormancyAdapter;
...
/**
 * Author FGB
 * Description 已超时成会员服务--休眠激活
 * Created at 2018/2/27 17:33
 * Version 1.0
 */

public class TimeOutMemberServiceDormancyFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private TimeOutMemberServiceDormancyAdapter adapter;
     ...
     * 单例
     */
    public static TimeOutMemberServiceDormancyFragment newInstance() {
        TimeOutMemberServiceDormancyFragment fragmentCommon = new TimeOutMemberServiceDormancyFragment();
    ...
    public void initData() {
        net=new DormancyListNet(getContext(),3);
    ...
    public void onEventMainThread(ResultDormancyServiceTimeOutListBean msg) {
        if(msg.IsSuccess!=false){
            if(msg.TModel!=null && msg.TModel.size()!=0){
                tv_not_data.setVisibility(View.GONE);
                mData=new ArrayList<>();
                mData.addAll(msg.TModel);
                adapter=new TimeOutMemberServiceDormancyAdapter(mData,getActivity(),getContext());
