...
public class MemberCheckDealServiceAdapter extends BaseQuickAdapter<CheckServiceDetailsBean, BaseViewHolder> {

    private List<CheckServiceDetailsBean> mData;

    public MemberCheckDealServiceAdapter(List<CheckServiceDetailsBean> mData) {
        super( R.layout.item_member_check_deal_service,mData);
        this.mData=mData;
    }
...
//            helper.setTextColor(R.id.tv_service_result,mContext.getResources().getColor(R.color.red));
        }
