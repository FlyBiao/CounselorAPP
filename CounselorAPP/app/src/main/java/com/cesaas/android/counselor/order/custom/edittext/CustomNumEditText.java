package com.cesaas.android.counselor.order.custom.edittext;
...
/**
 * Author FGB
 * Description 自定义EditText右下角计数
 * Created 2017/3/17 11:48
 * Version 1.zero
 */
public class CustomNumEditText extends RelativeLayout {
    //类型1(单数类型)：TextView显示总字数，然后根据输入递减.例：100，99，98
    //类型2(百分比类型)：TextView显示总字数和当前输入的字数，例：zero/100，1/100，2/100
    ...
    public CustomNumEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     * @return
     */
    public CustomNumEditText setLineColor(String color){
     ...
     * @return
     */
    public CustomNumEditText setType(String type){
        TYPES = type;
        return this;
    }
     ...
     * @return
     */
    public CustomNumEditText setLength(int num){
        this.MaxNum = num;
        return this;
    }
     ...
     * @return
     */
    public CustomNumEditText setEtHint(String str){
     ...
     * @return
     */
    public CustomNumEditText setEtMinHeight(int px){
