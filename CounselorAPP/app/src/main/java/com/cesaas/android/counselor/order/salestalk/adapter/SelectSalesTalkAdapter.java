...
public class SelectSalesTalkAdapter extends SwipeMenuAdapter<SelectSalesTalkAdapter.DefaultViewHolder> {

    private List<ResultCustomListBean.CustomListBean> customListBeanList;
    private OnItemClickListener mOnItemClickListener;

    public SelectSalesTalkAdapter(List<ResultCustomListBean.CustomListBean> customListBeanList){
