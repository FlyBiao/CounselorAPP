...
import com.cesaas.android.counselor.order.member.fragment.service.birth.CompleteMemberServiceBirthFragment;
import com.cesaas.android.counselor.order.member.fragment.service.birth.DealMemberServiceBirthFragment;
import com.cesaas.android.counselor.order.member.fragment.service.birth.MoreMemberServiceBirthFragment;
...
public class MemberServiceContiueFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        try{
            ...
            TabViewChild tabViewChild1 = new TabViewChild(R.mipmap.deals, R.mipmap.deal, "待处理", DealMemberServiceContiueFragment.newInstance());
            TabViewChild tabViewChild2 = new TabViewChild(R.mipmap.completes, R.mipmap.complete, "已完成", CompleteMemberServiceContiueFragment.newInstance());
//            TabViewChild tabViewChild3 = new TabViewChild(R.mipmap.timeouts, R.mipmap.timeout, "超时逾期", TimeOutMemberServiceBirthFragment.newInstance());
            TabViewChild tabViewChild4 = new TabViewChild(R.mipmap.mores, R.mipmap.more_s, "更多", MoreMemberServiceBirthFragment.newInstance());
