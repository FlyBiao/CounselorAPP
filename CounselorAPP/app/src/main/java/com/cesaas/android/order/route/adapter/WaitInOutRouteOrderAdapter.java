...
public class WaitInOutRouteOrderAdapter extends BaseQuickAdapter<UnReceiveOrderBean, BaseViewHolder> {
    ...
    public WaitInOutRouteOrderAdapter(List<UnReceiveOrderBean> mData, Activity activity, Context context) {
        super( R.layout.item_waitin_route_order,mData);
        this.mData=mData;
