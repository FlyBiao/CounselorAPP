...
import com.cesaas.android.counselor.order.member.adapter.service.continues.MemberCompleteServiceContiuneAdapter;
...
public class CompleteMemberServiceContiueFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private MemberCompleteServiceContiuneAdapter adapter;
     ...
     * 单例
     */
    public static CompleteMemberServiceContiueFragment newInstance() {
        CompleteMemberServiceContiueFragment fragmentCommon = new CompleteMemberServiceContiueFragment();
    ...
    public void onEventMainThread(ResultCompleteGetSecondListBean msg) {
        if(msg.IsSuccess!=false){
            ...
            if(msg.TModel!=null && msg.TModel.size()!=0){
                ...
                adapter=new MemberCompleteServiceContiuneAdapter(mData,getActivity(),getContext());
