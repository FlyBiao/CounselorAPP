...
public class CustomBusinessCenterProgress extends View {
...
//    private int[] colors = new int[]{Color.GREEN, Color.YELLOW, Color.RED, Color.RED};
    ...
    public CustomBusinessCenterProgress(Context context) {
        super(context);
    }

    public CustomBusinessCenterProgress(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//        canvas.drawText("胖", getWidth()-marging, centerX+marging+textSize+padding, vTextPaint);
        ...
        canvas.drawText("商务中心", getWidth()/2, (int)((centerX+marging)/3*1.5+textSize), vTextPaint);
