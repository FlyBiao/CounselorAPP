 ...
 * 会员忠诚度服务报表
 */
public class MemberLoyAltyActivity extends BasesActivity {
    ...
    public void initView(){
        ...
        mTextViewTitle.setText("忠诚度服务分析");
    ...
    public void initData(){
        ...
        WebViewUtils.initWebSettings(wv_member,mDialog, Urls.SERVICE_LOYALTY);
