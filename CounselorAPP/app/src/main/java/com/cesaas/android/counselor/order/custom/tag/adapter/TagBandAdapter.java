 ...
 */
public class TagBandAdapter<T> extends BaseAdapter implements OnInitSelectedPosition {

    private final Context mContext;
    private final List<GetTagListBean> mDataList;

    public TagBandAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.tag_band_item, null);
