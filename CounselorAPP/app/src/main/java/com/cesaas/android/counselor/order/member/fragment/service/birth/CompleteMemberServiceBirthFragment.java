...
import com.cesaas.android.counselor.order.member.adapter.service.birth.CompleteMemberServiceBirthAdapter;
...
/**
 * Author FGB
 * Description 已完成会员服务-生日祝福
 * Created at 2018/2/27 17:33
 * Version 1.0
 */

public class CompleteMemberServiceBirthFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private CompleteMemberServiceBirthAdapter adapter;
     ...
     * 单例
     */
    public static CompleteMemberServiceBirthFragment newInstance() {
        CompleteMemberServiceBirthFragment fragmentCommon = new CompleteMemberServiceBirthFragment();
    ...
    public void initData() {
        net=new BirthListNet(getContext(),2);
    ...
    public void onEventMainThread(ResultBirthdayWishesServiceCompleteListBean msg) {
        if(msg.IsSuccess!=false){
            ...
            if(msg.TModel!=null && msg.TModel.size()!=0){
                ...
                adapter=new CompleteMemberServiceBirthAdapter(mData,getActivity(),getContext());
