 ...
 * 商品销量
 */
public class ShopSalesActivity extends BasesActivity {
    ...
    public void initView(){
        ...
        wv_member= (WebView) findViewById(R.id.wv_into_shop_sales);
    ...
    public void initData(){
        ...
        WebViewUtils.initWebSettings(wv_member,mDialog, Urls.SHOP_SALES);
