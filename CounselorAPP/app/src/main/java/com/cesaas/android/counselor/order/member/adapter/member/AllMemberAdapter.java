...
public class AllMemberAdapter extends BaseQuickAdapter<MemberServiceListBean, BaseViewHolder> {

    private List<MemberServiceListBean> mData;
    private Activity mActivity;
    private Context mContext;

    public AllMemberAdapter(List<MemberServiceListBean> mData, Activity activity, Context context) {
        super( R.layout.item_all_member,mData);
        this.mData=mData;
    ...
    @Override
    protected void convert(BaseViewHolder helper, final MemberServiceListBean item) {
        ...
        helper.setOnClickListener(R.id.ll_member_audit, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BottonDialogUtils.showBottonDialog(mContext,mActivity,item,1);
            }
      ...
      helper.setOnClickListener(R.id.ll_remark, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BottonDialogUtils.setMemberRemarkDialog(mContext,mActivity,item,1);
            }
        });
    }
}
