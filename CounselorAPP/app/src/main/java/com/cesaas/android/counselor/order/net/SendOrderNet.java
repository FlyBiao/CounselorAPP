 ...
 *
 */
public class SendOrderNet extends BaseNet{

	public SendOrderNet(Context context) {
		super(context, true);
		this.uri="Order/Sw/Express/SendOrder";
	}
	...
	protected void mSuccess(String rJson) {
		...
		Gson gson = new Gson();
		ResultSendOrderBean lbean = gson.fromJson(rJson, ResultSendOrderBean.class);
		if (lbean.IsSuccess) {
