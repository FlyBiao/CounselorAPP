...
import com.cesaas.android.counselor.order.member.fragment.service.volume.SendVolueTabLayoutAdapter;
 ...
 * 推送卷首页
 */
public class SendVolumeActivity extends BasesActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_send_volume);
    ...
    public void initData(){
        PagerAdapter adapter= new SendVolueTabLayoutAdapter(getSupportFragmentManager());
