...
/**
 * Author FGB
 * Description 我的关注商品Adapter
 * Created 2017/4/27 17:57
 * Version 1.0
 */
public class MyAttentionShopAdapter extends SwipeMenuAdapter<MyAttentionShopAdapter.DefaultViewHolder>{
    ...
    public MyAttentionShopAdapter(List<AllShopBean> mAllShopBeanList,Context mContext){
