...
public class AllShopFragment extends Fragment {
    ...
    public static AllShopFragment newInstance() {
        AllShopFragment fragmentCommon = new AllShopFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.fragmant_all_shop_layout, container, false);
        initView();
        return view;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mGetAllShopNet=new GetAllShopNet(getContext());
        mGetAllShopNet.setData(pageIndex,Type);
    ...
    private void initView() {
        ...
        mSwipeMenuRecyclerView= (SwipeMenuRecyclerView) view.findViewById(R.id.recycler_all_shop_view);
    ...
    public class GetAllShopNet extends BaseNet {
        ...
        protected void mSuccess(String rJson) {
            ...
            if(bean.IsSuccess==true){
                ...
                mAllShopAdapter=new AllShopAdapter(mAllShopBeanList,getContext());
