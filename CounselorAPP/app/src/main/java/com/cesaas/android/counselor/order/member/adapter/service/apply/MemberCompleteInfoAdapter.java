...
/**
 * Author FGB
 * Description 手机和生日修改申请列表-已完成
 * Created at 2018/2/27 10:56
 * Version 1.0
 */

public class MemberCompleteInfoAdapter extends BaseQuickAdapter<MemberApplyListBean, BaseViewHolder> {

    private Activity mActivity;
    private List<MemberApplyListBean> mData;

    public MemberCompleteInfoAdapter(List<MemberApplyListBean> mData, Activity activity) {
        super( R.layout.item_member_complete_info,mData);
        this.mData=mData;
