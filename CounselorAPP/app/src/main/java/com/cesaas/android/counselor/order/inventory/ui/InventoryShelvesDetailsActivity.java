...
import com.cesaas.android.counselor.order.inventory.net.CreateInventoryNet;
import com.cesaas.android.counselor.order.inventory.net.GetOneInfoNet;
import com.cesaas.android.counselor.order.inventory.net.UpdateGoodsNumNet;
...
public class InventoryShelvesDetailsActivity extends BasesActivity implements View.OnClickListener{
     ...
     * @param msg
     */
    public void onEventMainThread(ResultUpdateGoodsBean msg) {
        if(msg.IsSuccess!=false){
                ToastFactory.getLongToast(mContext,"修改成功！");
                initData();
                baseDialog.dismiss();
        }else{
            ToastFactory.getLongToast(mContext,"失败！"+msg.Message);
        }
    }
     ...
     * @param msg
     */
    public void onEventMainThread(ResultGetOneInfoBean msg) {
        if(msg.IsSuccess!=false){
            ...
            ToastFactory.getLongToast(mContext,"获取货架信息失败！"+msg.Message);
        }
    }
     ...
     * @param msg
     */
    public void onEventMainThread(ResultCreateInventoryBean msg) {
        if(msg.IsSuccess!=false){
            ToastFactory.getLongToast(mContext,"新建盘点单成功！");
            Skip.mNext(mActivity,InventoryMainActivity.class);
        }else{
            ToastFactory.getLongToast(mContext,"新建盘点单失败！"+msg.Message);
        }
    }
     ...
     * @param msg
     */
    public void onEventMainThread(ResultAddInventoryGoodsBean msg) {
        if(msg.IsSuccess!=false){
            ...
            ToastFactory.getLongToast(mContext,"添加盘点商品失败！"+msg.Message);
        }
    }
