...
public class BossGoodsFragment extends BaseFragment {

    private TextView tvTitle,tvLeftTitle,mTextViewRightTitle;
    private ImageView ivShare,ivSelect;
    private WebView wv_merchant_report;
    private ScrollView sv_shop_img;
    private LinearLayout ll_base_title_back,ll_base_title_left,llBack;
     ...
     * 单例
     */
    public static BossGoodsFragment newInstance() {
        BossGoodsFragment fragmentCommon = new BossGoodsFragment();
        return fragmentCommon;
    }

    public void onEventMainThread(QueryGoodsEventBean msg) {
        if(msg.getQueryType()==2){
            Intent shopQuery= new Intent(getContext(), QueryReportActivity.class);
            shopQuery.putExtra("type",msg.getType());
            startActivityForResult(shopQuery,304);
        }
    }
    ...
    public void onEventMainThread(QueryShopEventBean msg) {
        if(msg.getQueryType()==2){
            ...
            intentShop.putExtra("LeftTitle","商品报表");
    ...
    public int getLayoutId() {
        return R.layout.fragment_boss_goods;
    }
    ...
    public void initViews() {
        ...
        wv_merchant_report=findView(R.id.wv_merchant_report);
        tvTitle=findView(R.id.tv_base_title);
        tvTitle.setText("商品报表");
        ll_base_title_left=findView(R.id.ll_base_title_left);
        ll_base_title_left.setVisibility(View.GONE);
    ...
    public void initData() {
        ...
        WebViewUtils.initWebSettings(wv_merchant_report,mDialog, Urls.RESULTS_MERCHANT_REPORT+type);
        BaseInitJavascriptInterface.initJavascriptInterface(getContext(),getActivity(),mMaterialDialog,wv_merchant_report,bundle,prefs,tvTitle,mTextViewRightTitle,0,101,2,0);
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        BaseActivityResult result=new BaseActivityResult(getContext(),getActivity(),wv_merchant_report);
            ...
            public void onFailure(PutObjectRequest arg0,
                ...
                if (clientExcepion != null) {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ToastFactory.getLongToast(getContext(),"本地异常如网络异常！");
                        }
                    });
                }
            ...
            public void onSuccess(PutObjectRequest request, PutObjectResult result) {
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        //执行分享操作
                        //执行分享操作
                        showShare(tvTitle.getText().toString(),ossImageUrl,ossImageUrl,"商品分析");
                    }
                });
            }
        });
