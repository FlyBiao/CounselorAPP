...
public class CompleteMemberServiceFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private CompleteMemberServiceVisitAdapter adapter;
     ...
     * 单例
     */
    public static CompleteMemberServiceFragment newInstance() {
        CompleteMemberServiceFragment fragmentCommon = new CompleteMemberServiceFragment();
    ...
    public void initData() {
        net=new VisitListNet(getContext(),2);
    ...
    public void onEventMainThread(ResultVisitServiceCompleteListBean msg) {
        if(msg.IsSuccess!=false){
            ...
            if(msg.TModel!=null && msg.TModel.size()!=0){
                ...
                adapter=new CompleteMemberServiceVisitAdapter(mData,getActivity(),getContext());
