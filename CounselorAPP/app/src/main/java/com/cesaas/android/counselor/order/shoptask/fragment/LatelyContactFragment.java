...
public class LatelyContactFragment extends Fragment {
    ...
    private int type=1;	//查询类型： 0=全部，1=最近联系人，2=组联系人，3=部门联系人
     ...
     * 单例
     */
    public static LatelyContactFragment newInstance() {
        LatelyContactFragment fragmentCommon = new LatelyContactFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.fragment_lately_contact_layout, container, false);
        initView();
        return view;
    }
    ...
    private void initData(){
        ...
        mCounselorListNet.setData(pageIndex,type,"");
    }
    ...
    private void initView() {
        ...
        mSwipeMenuRecyclerView = (SwipeMenuRecyclerView) view.findViewById(R.id.recycler_lately_contact_view);
