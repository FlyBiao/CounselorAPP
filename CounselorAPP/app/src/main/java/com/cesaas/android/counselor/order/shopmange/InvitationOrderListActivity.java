 ...
 * 邀单计划
 */
public class  InvitationOrderListActivity extends BasesActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_invitation_order_list);

        mMaterialDialog=new MaterialDialog(mContext);

        //getSupportFragmentManager().beginTransaction().add(R.id.frame_layout, new InvitationSampleFragment()).commit();
        initView();
        initData();
    }
    ...
    public void initData(){
        ...
        WebViewUtils.initWebSettings(wv_member,mDialog, Urls.INVITATION_ORDER);
