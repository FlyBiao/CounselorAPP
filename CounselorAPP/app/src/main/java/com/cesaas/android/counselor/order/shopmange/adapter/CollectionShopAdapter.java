...
/**
 * Author FGB
 * Description TA的收藏商品Adapter
 * Created 2017/4/27 17:57
 * Version 1.0
 */
public class CollectionShopAdapter extends SwipeMenuAdapter<CollectionShopAdapter.DefaultViewHolder>{
    ...
    public CollectionShopAdapter(List<AllShopBean> mAllShopBeanList,Context mContext){
