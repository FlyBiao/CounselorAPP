...
public class TopRightMenu {
    ...
    public TopRightMenu(Activity context,int count) {
    ...
    private void init() {
        ...
        mAdapter = new TRMenuAdapter(mContext, this, menuItemList, showIcon,count);
    }
     ...
     * @return
     */
    public TopRightMenu addMenuItem(MenuItemMenu item){
     ...
     * @return
     */
    public TopRightMenu addMenuList(List<MenuItemMenu> list){
