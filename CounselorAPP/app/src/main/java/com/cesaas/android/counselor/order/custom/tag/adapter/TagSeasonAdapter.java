 ...
 */
public class TagSeasonAdapter<T> extends BaseAdapter implements OnInitSelectedPosition {

    private final Context mContext;
    private final List<GetTagListBean> mDataList;

    public TagSeasonAdapter(Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.tag_season_item, null);

        TextView textView = (TextView) view.findViewById(R.id.tv_tag);
        if(mDataList.get(position).getTitle()!=null && !"".equals(mDataList.get(position).getTitle())){
