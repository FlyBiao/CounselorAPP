...
public class InventoryDetailsAdapter extends SwipeMenuAdapter<InventoryDetailsAdapter.DefaultViewHolder> {
    ...
    private List<InventoryGetScopeListBean> titles;
    private OnItemClickListener mOnItemClickListener;

    private Context ct;
    private  Activity activity;

    public InventoryDetailsAdapter(List<InventoryGetScopeListBean> titles, Context ct, Activity activity) {
        this.titles = titles;
        this.ct=ct;
    ...
    public void onBindViewHolder(final InventoryDetailsAdapter.DefaultViewHolder holder, final int position) {
        holder.setData(titles.get(position).getTitle(),titles.get(position).getNum(),titles.get(position).getCreateName());


    }

    static class DefaultViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView tv_inventory_number,tv_shelf_goods,tv_shelf_name;
        ...
        public DefaultViewHolder(View itemView) {
            ...
            tv_shelf_name= (TextView) itemView.findViewById(R.id.tv_shelf_name);
        }

        public void setData(String Shelf,int Number,String CreateName) {
            this.tv_shelf_goods.setText(Shelf);
            this.tv_inventory_number.setText(String.valueOf(Number));
            this.tv_shelf_name.setText(CreateName);
        }
