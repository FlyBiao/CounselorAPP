...
public class MemberTimeOutInfoAdapter extends BaseQuickAdapter<MemberApplyListBean, BaseViewHolder> {
    ...
    public MemberTimeOutInfoAdapter(List<MemberApplyListBean> mData, Activity activity) {
        super( R.layout.item_member_timeout_info,mData);
        this.mData=mData;
