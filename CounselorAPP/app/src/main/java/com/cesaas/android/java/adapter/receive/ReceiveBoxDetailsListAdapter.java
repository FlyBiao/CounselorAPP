...
public class ReceiveBoxDetailsListAdapter extends BaseQuickAdapter<MoveDeliveryGoodsDetailBean, BaseViewHolder> {
    ...
    public ReceiveBoxDetailsListAdapter(List<MoveDeliveryGoodsDetailBean> mData, Activity activity, Context ct) {
    ...
    protected void convert(BaseViewHolder helper, final MoveDeliveryGoodsDetailBean item) {
        ...
        helper.setText(R.id.tv_receive_num,String.valueOf(item.getNum()));
