...
public class MenuPowerNet {
	...
	public MenuPowerNet(Context context, boolean show) {
...
//					Log.i(TAG, "auth=="+auth.toString());
			...
			http.send(HttpMethod.GET, SwitchServerUtils.getServerUrl() + uri, params, new RequestCallBack<HttpUtils>() {
				@Override
