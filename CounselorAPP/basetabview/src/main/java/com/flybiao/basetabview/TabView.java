...
public class TabView extends RelativeLayout {
    ...
    private void initDefaultAttrs(Context context) {
        ...
        mHeight = dp2px(context, 45);
        mImgToTextGap = dp2px(context, 2);
        mTextSize = sp2px(context, 12);

        mImgWidth = dp2px(context, 26);
        mImgHeight = dp2px(context, 26);
    }
    ...
    private void initView(Context context) {
        ...
        if (mTabViewGravity == Gravity.BOTTOM) {
            tabViewParams = new LayoutParams(LayoutParams.MATCH_PARENT, mHeight);
            ...
            tabViewParams = new LayoutParams(mHeight, LayoutParams.MATCH_PARENT);
