...
import cn.bingoogolapple.photopicker.util.BGABrowserPhotoViewsAttacher;
import cn.bingoogolapple.photopicker.util.BGAPhotoPickerUtil;
import cn.bingoogolapple.photopicker.widget.BGAImageView;
import uk.co.senab.photoview.PhotoViewsAttacher;
...
public class BGAPhotoPageAdapter extends PagerAdapter {
    ...
    private PhotoViewsAttacher.OnViewTapListener mOnViewTapListener;
    private Activity mActivity;

    public BGAPhotoPageAdapter(Activity activity, PhotoViewsAttacher.OnViewTapListener onViewTapListener, ArrayList<String> previewImages) {
    ...
    public View instantiateItem(ViewGroup container, int position) {
        ...
        final BGABrowserPhotoViewsAttacher photoViewAttacher = new BGABrowserPhotoViewsAttacher(imageView);
