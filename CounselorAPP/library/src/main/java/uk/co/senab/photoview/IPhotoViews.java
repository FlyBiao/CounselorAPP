...
public interface IPhotoViews {
    ...
    /**
     * Returns true if the PhotoViews is set to allow zooming of Photos.
     *
     * @return true if the PhotoViews allows zooming.
     */
    boolean canZoom();
     ...
     *
     * @param finalMatrix target matrix to set PhotoViews to
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(PhotoViewsAttacher.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(PhotoViewsAttacher.OnPhotoTapListener listener);

    /**
     * PhotoViewsAttacher.OnPhotoTapListener reference should be stored in a variable instead, this
     * will be removed in future release.
     * <p>&nbsp;</p>
     * Returns a listener to be invoked when the Photo displayed by this View is tapped with a
     * single tap.
     *
     * @return PhotoViewsAttacher.OnPhotoTapListener currently set, may be null
     */
    @Deprecated
    PhotoViewsAttacher.OnPhotoTapListener getOnPhotoTapListener();
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(PhotoViewsAttacher.OnViewTapListener listener);

    /**
     * Enables rotation via PhotoViews internal functions.
     *
     * @param rotationDegree - Degree to rotate PhotoViews to, should be in range 0 to 360
     */
     ...
     * Enables rotation via PhotoViews internal functions.
     *
     * @param rotationDegree - Degree to rotate PhotoViews by, should be in range 0 to 360
     */
    void setRotationBy(float rotationDegree);

    /**
     * PhotoViewsAttacher.OnViewTapListener reference should be stored in a variable instead, this
     * will be removed in future release.
     * <p>&nbsp;</p>
     * Returns a callback listener to be invoked when the View is tapped with a single tap.
     *
     * @return PhotoViewsAttacher.OnViewTapListener currently set, may be null
     */
    @Deprecated
    PhotoViewsAttacher.OnViewTapListener getOnViewTapListener();
    ...
    /**
     * Enables rotation via PhotoViews internal functions. Name is chosen so it won't collide with
    ...
    /**
     * Allows to change zoom transition speed, default value is 200 (PhotoViewsAttacher.DEFAULT_ZOOM_DURATION).
    ...
    /**
     * Will return instance of IPhotoViews (eg. PhotoViewsAttacher), can be used to provide better
     * integration
     *
     * @return IPhotoViews implementation instance if available, null if not
     */
     ...
     * default, you can just pass in "null" or public field of PhotoViewsAttacher.defaultOnDoubleTapListener
     *
     ...
     */
    void setOnScaleChangeListener(PhotoViewsAttacher.OnScaleChangeListener onScaleChangeListener);
     ...
     */
    void setOnSingleFlingListener(PhotoViewsAttacher.OnSingleFlingListener onSingleFlingListener);
}
