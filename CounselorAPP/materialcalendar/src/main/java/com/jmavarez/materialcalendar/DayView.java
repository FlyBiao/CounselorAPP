...
public class DayView extends FrameLayout {
    ...
    private static final float DEFAULT_INDICATOR_SIZE = 6.0f;
    ...
    private Drawable getIndicatorDrawable() {
        if (_indicatorDrawable == null) {
            _indicatorDrawable = generateCircleDrawable(ContextCompat.getColor(getContext(), R.color.green_pressed));
        }
